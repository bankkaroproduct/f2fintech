    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14">
      ...
      {featured && (
        <div
          ...
          className="group mb-10 cursor-pointer grid grid-cols-1 lg:grid-cols-2 gap-0 bg-card rounded-2xl overflow-hidden border border-border/50 shadow-lg hover:shadow-2xl hover:border-[#3A49D6]/30 transition-all duration-300"
        >
          ...
          <div className="p-6 sm:p-8 flex flex-col justify-center">
            <div className="inline-flex items-center gap-1.5 text-xs text-[#3A49D6] font-semibold uppercase tracking-wide mb-3">
              Featured Article
            </div>
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-foreground mb-3 group-hover:text-[#3A49D6] transition-colors leading-tight">
              {featured.title}
            </h2>
            ...
            <div className="flex items-center gap-2 text-[#3A49D6] font-semibold text-sm group-hover:gap-3 transition-all">
              Read Article
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {rest.map((blog) => (
            <div
              ...
              className="group bg-card rounded-2xl overflow-hidden border border-border/50 shadow hover:shadow-xl hover:border-[#3A49D6]/30 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col"
            >
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <h3 className="font-bold text-foreground group-hover:text-[#3A49D6] transition-colors mb-2 leading-snug line-clamp-2 flex-1">
                  {blog.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-3 border-t border-border/50 mt-auto">
                  ...
                  <div className="flex items-center gap-1 text-[#3A49D6] text-xs font-semibold group-hover:gap-1.5 transition-all">
                    Read
