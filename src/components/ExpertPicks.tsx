        ...
        <div className="relative">
              ...
              >
                ...
                <div className="flex items-center justify-between px-4 pt-4 pb-2">
                  <span
                    ...
                    style={{ backgroundColor: "#3A49D6", color: "#FFFFFF" }}
                  >
                    {card.tag}
                  </span>
          ...
          <div className="flex justify-center gap-3 mt-8">
            <button
              ...
              style={{ border: "1px solid #3A49D6", color: "#3A49D6", backgroundColor: "transparent" }}
              aria-label="Previous"
            >
            ...
            <button
              onClick={next}
              className="h-11 w-11 rounded-full flex items-center justify-center transition-colors"
              style={{ backgroundColor: "#3A49D6", color: "white" }}
              aria-label="Next"
            >
