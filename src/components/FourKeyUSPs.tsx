          ...
          {features.map((feature, index) => {
            ...
            return (
              <div
                ...
                style={{ backgroundColor: "#F5F5F5", borderLeftColor: "#3A49D6" }}
              >
                {/* Circular Icon */}
                ...
                {/* Title */}
                <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold mb-2 sm:mb-3 min-h-[2.5rem] sm:min-h-[3rem] flex items-center px-1" style={{ color: "#3A49D6" }}>
                  {feature.title}
                </h3>
