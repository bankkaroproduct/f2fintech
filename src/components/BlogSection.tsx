    ...
    <section id="blog" ref={sectionRef} className="py-[var(--section-space-lg)] bg-gradient-to-br from-muted/30 via-background to-accent/10 scroll-mt-20">
      <div className="section-shell">
        ...
        <div className="text-center max-w-3xl mx-auto mb-14">
          ...
          <h2 className="fluid-h2 mb-3 text-[#3A49D6]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8 sm:mb-12">
          {blogs.map((blog, index) => (
            <div
              ...
              className="group bg-card rounded-xl sm:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-border/50 hover:border-[#3A49D6]/30 hover:-translate-y-1 sm:hover:-translate-y-2 cursor-pointer touch-target"
            >
              {/* Image */}
              ...
              <div className="p-4 sm:p-6">
                ...
                {/* Title */}
                <h3 className="text-base sm:text-lg md:text-xl font-bold mb-2 sm:mb-3 text-foreground group-hover:text-[#3A49D6] transition-colors line-clamp-2">
                  {blog.title}
                </h3>
                ...
                <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-border/50">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2 text-[#3A49D6] text-sm sm:text-base font-medium group-hover:translate-x-1 transition-all sm:ml-auto">
                    Read More
