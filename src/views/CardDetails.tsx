  ...
  return (
    <div className="min-h-screen bg-background pt-24 md:pt-28">
      ...
      <div className="section-shell py-8 sm:py-10 md:py-12 space-y-8 sm:space-y-10 md:space-y-12 pb-24 sm:pb-28">
              ...
              <div className="space-y-4">
                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-3 pb-4 border-b border-border">
                  ...
                  {card.joining_fee_offset && (
                    <div className="bg-[#F5F5F5] border border-[#3A49D6]/20 rounded-lg px-4 py-2.5 max-w-full md:max-w-sm">
          ...
          <section>
            ...
            <div className="flex flex-wrap gap-3">
              {card.tags.map((tag) => (
                <span
                  key={tag.id}
                  className="px-3 py-1 rounded-full text-sm font-medium bg-[#F5F5F5] text-primary border border-[#3A49D6]/20"
                >
                  {tag.name}
                </span>
              ))}
                  ...
                  >
                    <div className="p-6">
                      <div className="flex items-start gap-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#3A49D6] to-[#F5F5F5] flex items-center justify-center flex-shrink-0 shadow-md">
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-[#F5F5F5] via-[#F5F5F5]/10 to-accent/10 border-2 border-[#3A49D6]/20 rounded-2xl p-6 sm:p-8 lg:p-10 shadow-xl">
          ...
          <div className="grid gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 max-w-4xl mx-auto md:grid-cols-3">
            <div className="flex items-center gap-4 md:flex-col md:text-center md:items-center bg-background/70 border border-border rounded-2xl p-4 sm:p-5 shadow-md">
              <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-[#3A49D6] to-[#F5F5F5] text-primary-foreground rounded-2xl flex items-center justify-center text-xl sm:text-2xl font-bold shadow-lg">
                1
              </div>
